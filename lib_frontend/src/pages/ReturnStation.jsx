  ...
  return (
    <div className="min-h-screen flex flex-col text-white">
      ...
      <div className="flex-1 flex flex-col lg:flex-row">
        {/* Kiosk Panel */}
        <main className="flex-1 flex flex-col items-center justify-center p-8 glass-panel">
          <div className="w-full max-w-md flex flex-col gap-6">
            ...
            {returnStatus === 'idle' && (
              <div className="text-center flex flex-col items-center gap-4">
                ...
                <form onSubmit={handleGunScanSubmit} className="w-full glass-panel border border-white/20 p-6 rounded-2xl shadow-xl text-left flex flex-col gap-4 mt-4">
